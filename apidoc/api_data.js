define({ "api": [
  {
    "type": "post",
    "url": "/html",
    "title": "Request html screenshot",
    "group": "Main",
    "description": "<p>This endpoint requests a screenshot of the rendered html payload The user can supply various parameters, to define things like the viewport size, scaled picture sizes, js execution and more.</p>",
    "name": "createHTMLScreenshot",
    "parameter": {
      "fields": {
        "Parameter": [
          {
